...
async def get_workout(
    ...
    return await ws.get_workout_with_details(conn, workout_id, user_id)
...
async def update_workout(
    ...
    await ws.verify_workout_ownership(conn, workout_id, user_id)
    return await ws.update_workout(conn, workout_id, data.model_dump(exclude_unset=True))
...
async def complete_workout(
    ...
    await ws.verify_workout_ownership(conn, workout_id, user_id)
    return await ws.complete_workout(conn, workout_id)
...
async def delete_workout(
    ...
    await ws.verify_workout_ownership(conn, workout_id, user_id)
    await ws.soft_delete_workout(conn, workout_id)
...
async def add_exercise(
    ...
    return await ws.add_exercise_to_workout(
        conn, workout_id, data.exercise_id, data.sort_order, data.notes, data.rest_seconds
    )
...
async def remove_exercise(
    ...
    await ws.verify_workout_ownership(conn, workout_id, user_id)
    await ws.verify_workout_exercise(conn, workout_id, workout_exercise_id)
    await ws.remove_exercise_from_workout(conn, workout_exercise_id)
...
async def add_set(
    ...
    await ws.verify_workout_ownership(conn, workout_id, user_id)
    await ws.verify_workout_exercise(conn, workout_id, workout_exercise_id)
    return await ws.add_set(conn, workout_exercise_id, data.model_dump(exclude_unset=True))
...
async def update_set(
    ...
    await ws.verify_workout_ownership(conn, workout_id, user_id)
    await ws.verify_workout_exercise(conn, workout_id, workout_exercise_id)
    return await ws.update_set(conn, set_id, data.model_dump(exclude_unset=True))
...
async def delete_set(
    ...
    await ws.verify_workout_ownership(conn, workout_id, user_id)
    await ws.verify_workout_exercise(conn, workout_id, workout_exercise_id)
    await ws.delete_set(conn, set_id)
